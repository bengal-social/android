...
import org.smilodon.android.fragments.SplashFragment;
...
public class MainActivity extends FragmentStackActivity{
	...
	protected void onCreate(@Nullable Bundle savedInstanceState){
		...
		if(BuildConfig.BUILD_TYPE.startsWith("appcenter")){
			...
			try{
				Class.forName("org.smilodon.android.AppCenterWrapper").getMethod("init", Application.class).invoke(null, getApplication());
