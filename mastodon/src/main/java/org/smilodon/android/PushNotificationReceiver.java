...
import org.smilodon.android.api.requests.notifications.GetNotificationByID;
...
import org.smilodon.android.model.PushNotification;
...
public class PushNotificationReceiver extends BroadcastReceiver{
					...
					try{
						...
						new GetNotificationByID(pn.notificationId+"")
								.setCallback(new Callback<>(){
									@Override
									public void onSuccess(org.smilodon.android.model.Notification result){
	...
	private void notify(Context context, PushNotification pn, String accountID, org.smilodon.android.model.Notification notification){
